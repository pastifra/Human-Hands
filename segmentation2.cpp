...
int main( int argc, char** argv ){
    string folder_test = "/home/local/ceccmar29554/Desktop/progetto/test/*.jpg";
    vector<string> filenames_test;
    glob(folder_test, filenames_test);
    string folder_bboxes = "/home/local/ceccmar29554/Desktop/progetto/test/*.txt";
    vector<string> filenames_bboxes;
    glob(folder_bboxes, filenames_bboxes);
    string folder_got = "/home/local/ceccmar29554/Desktop/progetto/got/*.png";
